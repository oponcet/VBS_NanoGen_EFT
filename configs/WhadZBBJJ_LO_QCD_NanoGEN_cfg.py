...
# with command line options: Configuration/GenProduction/python/WhadZBBJJ_LO_QCD_cfg.py --python_filename nanogen_cfg.py --eventcontent NANOAODGEN --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAOD --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=123 --fileout file:WhadZBBJJ_LO_QCD_nanogen_123.root --conditions 130X_mcRun3_2023_realistic_v14 --beamspot Realistic25ns13p6TeVEarly2023Collision --step LHE,GEN,NANOGEN --geometry DB:Extended --era Run3 --no_exec --mc -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/WhadZBBJJ_LO_QCD_cfg.py nevts:100'),
...
process.NANOAODGENoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:WhadZBBJJ_LO_QCD_NanoGEN.root'),
...
process.externalLHEProducer = cms.EDProducer(
    'ExternalLHEProducer',
    args = cms.vstring('/srv/WhadZBBJJ_LO_QCD_el8_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
